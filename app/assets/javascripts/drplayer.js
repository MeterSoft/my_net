...
"&amp;bufferColor=" + settings.bufferColor;
    ...
    function pause(el) {
        $(el).each(function() {
            var id = $(this).data("id");
			el.find(".current").find(".btns").removeClass("play").removeClass("pause").addClass("play");
    ...
    function resume(el) {
        $(el).each(function() {
			...
			el.find(".current").find(".btns").removeClass("play").removeClass("pause").addClass("pause");
